  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-[#1E5BA8]">Welcome Back!</h2>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            type="submit"
            disabled={isPending}
            className="w-full bg-gradient-to-br from-[#1e7ae4] to-[#052f5e] text-white px-6 py-2.5 rounded-md shadow-md hover:opacity-90 transition-all duration-300"
          >
